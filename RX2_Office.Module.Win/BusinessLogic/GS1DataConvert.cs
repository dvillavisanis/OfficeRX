...
/// <summary>
/// DO NOT USE  OLD *****************************   use gs1dataconvert2
/// 
/// </summary>
namespace RX2_Office.Module.BusinessObjects.BusinessLogic
{
    public class GS1DataUtilold
    {
        ...
        public void GS1DataConvert(string pBarcode)
        {
           ...
           // Int32 aiCheckSum = 0;
            ...
            if (pBarcode.Contains("17"))
            {
                ...
                aiFull = pBarcode.Substring(index - 2, sai.maxLength + 2);
                aiValue = pBarcode.Substring(index, sai.maxLength);
            ...
            if (pBarcode.Contains("10"))
            {
                ...
                aiValue = pBarcode.Substring(index, aiMaxLength-2);
                 pBarcode = pBarcode.Replace(aiFull, String.Empty);
