...

{
    ...
    // [ListViewFilter(" All Customers who Purchase In 30 Days ", "[LastInvoiceDate] >=  ADDDAYS(LocalDateTimeToday() && IsCurrentUserInRole﻿('Admin') , -30)", " All Customers who Purchase In 30 Days ", " All Customers who Purchase In 30 Days", false)]
    // [ListViewFilter(" All Customers who Purchase In 60 Days ", "[LastInvoiceDate] >=  ADDDAYS(LocalDateTimeToday(), -60)",  " All Customers who Purchase In 60 Days ", " All Customers who Purchase In 60 Days", false)]
    // [ListViewFilter("All", "")]
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (http://documentation.devexpress.com/#Xaf/CustomDocument3146).
        ...
        [Index(4)]
        [ModelDefault("DisplayFormat", "(\\(\\d\\d\\d\\))?\\d{1,3}-\\d\\d-\\d\\d")]
