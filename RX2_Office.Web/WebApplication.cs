...
namespace RX2_Office.Web
{
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class RX2_OfficeAspNetApplication : WebApplication
    {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private RX2_Office.Module.RX2_OfficeModule module3;
        private RX2_Office.Module.Web.RX2_OfficeAspNetModule module4;
        ...
        private Module.RX2_OfficeModule rX2_OfficeModule1;
        ...
        public RX2_OfficeAspNetApplication()
        {
            InitializeComponent();
        }
        ...
        private void RX2_OfficeAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
            ...
            else
            {
                string message = "The application cannot connect to the specified database, because the latter doesn't exist or its version is older than that of the application.\r\n" +
                    ...
                    "'Update Application and Database Versions' at http://www.solidtsi.com" +
                    "'Database Security References' at http://www.solidtsi.com" +
                    "If this doesn't help, please contact our Support Team at http://www.atlanticbiologicals.com";
        ...
        private void InitializeComponent()
        {
            ...
            this.module3 = new RX2_Office.Module.RX2_OfficeModule();
            this.module4 = new RX2_Office.Module.Web.RX2_OfficeAspNetModule();
            ...
            this.rX2_OfficeModule1 = new RX2_Office.Module.RX2_OfficeModule();
            ...
            // 
            // RX2_OfficeAspNetApplication
            // 
            this.ApplicationName = "RX2_Office";
            ...
            this.Modules.Add(this.rX2_OfficeModule1);
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.RX2_OfficeAspNetApplication_DatabaseVersionMismatch);
